...
var routes = [
  ...
  __spreadValues({
    path: "store-setup",
    loadComponent: () => import("./chunk-CMC2AWCQ.js").then((m) => m.StoreSetup),
  ...
  __spreadValues({
    path: "profile",
    loadComponent: () => import("./chunk-475ORI5K.js").then((m) => m.CorporateProfileLayout),
    canActivate: [authGuard, roleGuard],
    data: { roles: ["CORPORATE"], requireStore: true },
    children: [
      {
        path: "details",
        loadComponent: () => import("./chunk-YN5ZD52H.js").then((m) => m.CorporateProfileDetails)
      },
  ...
  // Ana panel — Ember sidebar layout
  {
    ...
    children: [
      __spreadValues({
        path: "dashboard",
        loadComponent: () => import("./chunk-LHCEFYZC.js").then((m) => m.CorporateDashboard),
        data: { requireStore: true }
      }, false ? { \u0275entryName: "src/app/features/corporate/dashboard/dashboard.ts" } : {}),
      __spreadValues({
        path: "catalog",
        loadComponent: () => import("./chunk-ASSPRBMP.js").then((m) => m.CatalogList),
        data: { requireStore: true }
      }, false ? { \u0275entryName: "src/app/features/corporate/catalog/catalog-list/catalog-list.ts" } : {}),
      __spreadValues({
        path: "inventory",
        loadComponent: () => import("./chunk-3LMBQFOL.js").then((m) => m.Inventory),
        data: { requireStore: true }
      }, false ? { \u0275entryName: "src/app/features/corporate/inventory/inventory.ts" } : {}),
      __spreadValues({
        path: "orders",
        loadComponent: () => import("./chunk-2R4CFSKP.js").then((m) => m.StoreOrders),
        data: { requireStore: true }
      }, false ? { \u0275entryName: "src/app/features/corporate/orders/store-orders.ts" } : {}),
      __spreadValues({
        path: "refunds",
        loadComponent: () => import("./chunk-4PSFGUAS.js").then((m) => m.StoreRefunds),
        data: { requireStore: true }
      }, false ? { \u0275entryName: "src/app/features/corporate/refunds/store-refunds.ts" } : {}),
      __spreadValues({
        path: "analytics",
        loadComponent: () => import("./chunk-W7U73CT5.js").then((m) => m.SalesAnalytics),
        data: { requireStore: true }
      }, false ? { \u0275entryName: "src/app/features/corporate/analytics/sales-analytics.ts" } : {}),
      __spreadValues({
        path: "customers",
        loadComponent: () => import("./chunk-QI4X4WH6.js").then((m) => m.CustomerSegmentation),
        data: { requireStore: true }
      }, false ? { \u0275entryName: "src/app/features/corporate/customers/customer-segmentation.ts" } : {}),
      __spreadValues({
        path: "reviews",
        loadComponent: () => import("./chunk-V24CVUKH.js").then((m) => m.StoreReviews),
        data: { requireStore: true }
...
//# sourceMappingURL=chunk-GUSVX3PE.js.map
