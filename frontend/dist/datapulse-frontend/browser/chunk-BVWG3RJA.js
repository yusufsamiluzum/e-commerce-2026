...
var routes = [
  {
    ...
    children: [
      ...
      __spreadValues({
        path: "dashboard",
        loadComponent: () => import("./chunk-MDT4RYOA.js").then((m) => m.AdminDashboard)
      }, false ? { \u0275entryName: "src/app/features/admin/dashboard/admin-dashboard.ts" } : {}),
      __spreadValues({
        path: "users",
        loadComponent: () => import("./chunk-KBZ3FZX4.js").then((m) => m.UserManagement)
      }, false ? { \u0275entryName: "src/app/features/admin/users/user-management.ts" } : {}),
      __spreadValues({
        path: "stores",
        loadComponent: () => import("./chunk-SCVRXRCI.js").then((m) => m.StoreManagement)
      }, false ? { \u0275entryName: "src/app/features/admin/stores/store-management.ts" } : {}),
      __spreadValues({
        path: "orders",
        loadComponent: () => import("./chunk-6VJHP3SH.js").then((m) => m.OrderManagement)
      }, false ? { \u0275entryName: "src/app/features/admin/orders/order-management.ts" } : {}),
      __spreadValues({
        path: "refunds",
        loadComponent: () => import("./chunk-JLZCGV6J.js").then((m) => m.RefundManagement)
      }, false ? { \u0275entryName: "src/app/features/admin/refunds/refund-management.ts" } : {}),
      __spreadValues({
        path: "analytics",
        loadComponent: () => import("./chunk-4JILLPP6.js").then((m) => m.PlatformAnalytics)
      }, false ? { \u0275entryName: "src/app/features/admin/analytics/platform-analytics.ts" } : {}),
      __spreadValues({
        path: "reviews",
        loadComponent: () => import("./chunk-K6ZNWW57.js").then((m) => m.ReviewModeration)
      }, false ? { \u0275entryName: "src/app/features/admin/reviews/review-moderation.ts" } : {}),
      __spreadValues({
        path: "categories",
        loadComponent: () => import("./chunk-WYXMK2YB.js").then((m) => m.CategoryManagement)
      }, false ? { \u0275entryName: "src/app/features/admin/categories/category-management.ts" } : {}),
      __spreadValues({
        path: "audit-logs",
        loadComponent: () => import("./chunk-CKJKUKZT.js").then((m) => m.AuditLogs)
      }, false ? { \u0275entryName: "src/app/features/admin/audit-logs/audit-logs.ts" } : {}),
      __spreadValues({
        path: "config",
        loadComponent: () => import("./chunk-L4T4BSLV.js").then((m) => m.SystemConfig)
      }, false ? { \u0275entryName: "src/app/features/admin/config/system-config.ts" } : {})
    ]
  }
];
...
//# sourceMappingURL=chunk-BVWG3RJA.js.map
