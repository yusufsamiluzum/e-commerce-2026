...
var routes = [
  ...
  __spreadValues({ path: "catalog", loadChildren: () => import("./chunk-TTJDRWOP.mjs").then((m) => m.CatalogModule), canActivate: [notCorporateGuard] }, true ? { \u0275entryName: "src/app/features/catalog/catalog-module.ts" } : {}),
  __spreadValues({ path: "cart", loadChildren: () => import("./chunk-ZUKZ6EYL.mjs").then((m) => m.CartModule), canActivate: [notCorporateGuard] }, true ? { \u0275entryName: "src/app/features/cart/cart-module.ts" } : {}),
  __spreadValues({ path: "checkout", loadChildren: () => import("./chunk-QCOJONQX.mjs").then((m) => m.CheckoutModule), canActivate: [notCorporateGuard] }, true ? { \u0275entryName: "src/app/features/checkout/checkout-module.ts" } : {}),
  __spreadValues({ path: "individual", loadChildren: () => import("./chunk-A55FGB6C.mjs").then((m) => m.IndividualModule), canActivate: [notCorporateGuard] }, true ? { \u0275entryName: "src/app/features/individual/individual-module.ts" } : {}),
  __spreadValues({ path: "auth", loadChildren: () => import("./chunk-GTRCRFZA.mjs").then((m) => m.AuthModule) }, true ? { \u0275entryName: "src/app/features/auth/auth-module.ts" } : {}),
  __spreadValues({ path: "admin", loadChildren: () => import("./chunk-ZNLASOWQ.mjs").then((m) => m.AdminModule) }, true ? { \u0275entryName: "src/app/features/admin/admin-module.ts" } : {}),
  __spreadValues({ path: "corporate", loadChildren: () => import("./chunk-E3ZNDAAD.mjs").then((m) => m.CorporateModule) }, true ? { \u0275entryName: "src/app/features/corporate/corporate-module.ts" } : {}),
