...
var routes = [
  ...
  __spreadValues({ path: "catalog", loadChildren: () => import("./chunk-GUG3ODNR.mjs").then((m) => m.CatalogModule), canActivate: [notCorporateGuard] }, true ? { \u0275entryName: "src/app/features/catalog/catalog-module.ts" } : {}),
  __spreadValues({ path: "cart", loadChildren: () => import("./chunk-Z73H3MDM.mjs").then((m) => m.CartModule), canActivate: [notCorporateGuard] }, true ? { \u0275entryName: "src/app/features/cart/cart-module.ts" } : {}),
  __spreadValues({ path: "checkout", loadChildren: () => import("./chunk-PIAOWD6E.mjs").then((m) => m.CheckoutModule), canActivate: [notCorporateGuard] }, true ? { \u0275entryName: "src/app/features/checkout/checkout-module.ts" } : {}),
  __spreadValues({ path: "individual", loadChildren: () => import("./chunk-6VNYZ4SN.mjs").then((m) => m.IndividualModule), canActivate: [notCorporateGuard] }, true ? { \u0275entryName: "src/app/features/individual/individual-module.ts" } : {}),
  __spreadValues({ path: "auth", loadChildren: () => import("./chunk-GQ7RKBYW.mjs").then((m) => m.AuthModule) }, true ? { \u0275entryName: "src/app/features/auth/auth-module.ts" } : {}),
  __spreadValues({ path: "admin", loadChildren: () => import("./chunk-IKOVQUBO.mjs").then((m) => m.AdminModule), canActivate: [authGuard, roleGuard], data: { roles: ["ADMIN"] } }, true ? { \u0275entryName: "src/app/features/admin/admin-module.ts" } : {}),
  __spreadValues({ path: "corporate", loadChildren: () => import("./chunk-AWPXAMFD.mjs").then((m) => m.CorporateModule) }, true ? { \u0275entryName: "src/app/features/corporate/corporate-module.ts" } : {}),
  __spreadValues({ path: "ai-assistant", loadComponent: () => import("./chunk-KQTGXF7O.mjs").then((m) => m.ChatbotPage), canActivate: [authGuard] }, true ? { \u0275entryName: "src/app/features/ai-assistant/chatbot-page.ts" } : {}),
